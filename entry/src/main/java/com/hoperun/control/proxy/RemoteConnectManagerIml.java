 ...
 * 远程管理类实现
 */
public class RemoteConnectManagerIml implements ConnectManager<Integer,Map<String,String>> {
    /**
     * 发送数据
     */
    ...
    private static final String TAG = RemoteConnectManagerIml.class.getName();
    ...
    public static synchronized ConnectManager getInstance() {
        if (instance == null) {
            instance = new RemoteConnectManagerIml();
        }
        return instance;
    }
    ...
    @Override
    public Integer sendRequest(int requestType, Map<String, String> params) {
        int result = 0;
        if (proxy != null) {
